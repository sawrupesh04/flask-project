...
export GCLOUD_PROJECT=$detail-217914
...
echo "Installing redis libraries"
...
gcloud projects add-iam-policy-binding $detail-217914 --member serviceAccount:quiz-account@$detail-217914.iam.gserviceaccount.com --role roles/owner
